...
class qpsk_modem(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._freq_offset_range = Range(-0.1, 0.1, 0.001, 0.01, 200)
        ...
        for c in range(0, 10):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._epsilon_range = Range(0.999, 1.001, 0.0001, 1.0005, 200)
        self._epsilon_win = RangeWidget(self._epsilon_range, self.set_epsilon, "Channel: Timing Offset", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_grid_layout.addWidget(self._epsilon_win, 0, 10, 1, 10)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(10, 20):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._delay_range = Range(0, 1000, 1, 52, 200)
        ...
        self.analog_random_source_x_0 = blocks.vector_source_b(list(map(int, numpy.random.randint(0, 256, 30000))), True)
